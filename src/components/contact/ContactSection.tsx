              ...
              <div>
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex flex-wrap gap-2">
                    <a href="https://linkedin.com/company/dxbmark" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 rounded-radius-default bg-white/5 border border-border-soft-val text-xs text-text-sub hover:bg-brand-primary/10 hover:border-brand-primary/45 hover:text-text-main transition-all duration-300" aria-label="LinkedIn Profile">LinkedIn</a>
                    <a href="https://share.google/ukdlkEaeQyY8yI51l" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 rounded-radius-default bg-white/5 border border-border-soft-val text-xs text-text-sub hover:bg-brand-primary/10 hover:border-brand-primary/45 hover:text-text-main transition-all duration-300" aria-label="Google Business Profile">Google Business</a>
                    <a href="https://github.com/dxbmark" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 rounded-radius-default bg-white/5 border border-border-soft-val text-xs text-text-sub hover:bg-brand-primary/10 hover:border-brand-primary/45 hover:text-text-main transition-all duration-300" aria-label="GitHub Profile">GitHub</a>
                    <a href="https://www.facebook.com/dxbmark" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 rounded-radius-default bg-white/5 border border-border-soft-val text-xs text-text-sub hover:bg-brand-primary/10 hover:border-brand-primary/45 hover:text-text-main transition-all duration-300" aria-label="Facebook Profile">Facebook</a>
                    <a href="https://www.instagram.com/dxbmarkllc" target="_blank" rel="noopener noreferrer" className="px-3 py-1.5 rounded-radius-default bg-white/5 border border-border-soft-val text-xs text-text-sub hover:bg-brand-primary/10 hover:border-brand-primary/45 hover:text-text-main transition-all duration-300" aria-label="Instagram Profile">Instagram</a>
                  </div>
