...
- [X] T030 [US3] Scaffold inactive QStash job queue table schema `src/db/migrations/0003_integration_jobs.sql`
- [X] T031 [US3] Add Sentry error capture calls to webhook route processing in `src/app/api/stripe/webhook/route.ts`
